...
class Gui():
    ...
    def populate(self) :
        ...
        self.slider_of_motor[RIGHT_SENSITIVITYA] = self.sliders.add_slider("Right Sensitivity", 0, 100)
        self.slider_of_motor[RIGHT_SENSITIVITY] = self.sliders.add_slider_alt(0, 100)
